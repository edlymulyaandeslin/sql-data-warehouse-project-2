...
--------------------------------------------------------------------------------
Purpose:
    Transform, clean, standardize, and load CRM & ERP data from Bronze to Silver.

Warning:
    Existing Silver Layer data will be truncated and replaced.
...
BEGIN
	...
	BEGIN TRY
		...
		*/
		...
		)t WHERE flag_last = 1 -- Select the most recent record per customer / remove duplicates value
		...
		*/
		...
		SELECT
			...
			prd_nm,
			COALESCE(prd_cost, 0) prd_cost, -- Converting value NULLs to 0
